    ...
    <Card>
        ...
        <CardContent>
            <ChartContainer config={chartConfig} className="max-h-[200px] w-full">
                ...
                <Area min={0} type={"natural"} fillOpacity={0.6} fill="var(--color-success)" stroke="var(--color-success)" stackId={"a"}   dataKey={"success"}/>
                <Area min={0} type={"natural"} fillOpacity={0.6} fill="var(--color-failed)" stroke="var(--color-failed)" stackId={"a"}     dataKey={"failed"}/>
                </AreaChart>
            </ChartContainer>
        </CardContent>
    </Card>
